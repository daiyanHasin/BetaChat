...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        p1.setBackground(new Color(113,216,230));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/BETACHAT!!.png"));
        ...
        JLabel name = new JLabel("GROUPCHAT");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 14));
        p1.add(name);
        
        JLabel status = new JLabel("Sadaf,Daiyan,AUST");
        ...
        try {
            ...
            System.out.println("Connected User Two");
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBackground(new Color(113, 216, 230));
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(UserTwo.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
